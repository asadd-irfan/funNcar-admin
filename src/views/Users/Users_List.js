...
export default function UsersList() {
  ...
  const CellMenu = (cell, row) => {
    return (
      <>
        <Link to={`/admin/user/${row.id}`}><button data-toggle="tooltip" title="View" className="pd-setting-ed"><i className="fa fa-eye" aria-hidden="true"></i></button></Link>
        <Link to={`/admin/User_Edit/${row.id}`}><button data-toggle="tooltip" title="Edit" className="pd-setting-ed"><i className="fa fa-pencil" aria-hidden="true"></i></button></Link>
