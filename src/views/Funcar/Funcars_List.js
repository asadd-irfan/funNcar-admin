...
export default function FuncarsList() {
  // Hooks
  ...
  const CellMenu = (cell, row) => {
    return (
      <>
        <Link to={`/admin/funncar/${row.id}`}><button data-toggle="tooltip" title="View" className="pd-setting-ed"><i className="fa fa-eye" aria-hidden="true"></i></button></Link>
        <Link to={`/admin/Funncar_Edit/${row.id}`}><button data-toggle="tooltip" title="Edit" className="pd-setting-ed"><i className="fa fa-pencil" aria-hidden="true"></i></button></Link>
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>Funncars List</h4>
