...
export default function FuncarView() {
  ...
  const editRecord = () =>{
    ...
    history.push({
      pathname: `/admin/Funncar_Edit/${Id}`,
  ...
  return (
    <GridContainer>
      ...
      <Button onClick={goBack} type="submit" color="primary">
        ...
        <Card profile>
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>Celebrity Preview</h4>
          </CardHeader>
      ...
      <UserTransactions id={Id} role={'Funncar'} user={FuncarDetails} authUser={user}/>
    </GridContainer >
  );
}