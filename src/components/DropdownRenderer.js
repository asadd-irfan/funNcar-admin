  ...
  setValues = (selectValues) => {
    if (!this.props.multi) {
      if (selectValues.length == 0) {
        // || selectValues[0][this.props.labelField] === selectValues[0][this.props.valueField]
        this.props.onChange(this.props.Type, 0);
      } else {
        this.props.onChange(
          this.props.Type,
          selectValues[0][this.props.valueField]
        );
      }
    } else {
  ...
  render() {
    return (
      <>
        ...
        <StyledSelect
          placeholder={
            !this.props.placeholder ? "Select" : this.props.placeholder
          }
