...
export default function PerformersList({
  ...
  const getParamString = (page = 1, exportToCSV = "") => {
    let paramString = `type=${selectedFilterVal}&key=performanceTable&page=${page}`;
    ...
    <>
      <Card className="card-height-fixed">
        <CardHeader color="primary">
          <h4 className={classes.cardTitleWhite}>Performers Bookings</h4>
        </CardHeader>
        <CardBody>
